...
const skills = [{
  title: <Translate text="app.root.main.skills.languages.title" />,
  icon: <LanguageIcon fontSize="large" />,
  description: <Translate text="app.root.main.skills.languages.description" />,
  ...
  description: <Translate text="app.root.main.skills.tools.description" />,
...
export default function Skills() {
  return (
    <Section title={<Translate text="app.root.main.skills.title" />}>
